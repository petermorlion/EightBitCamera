...
namespace EightBitCamera
{
    public partial class Existing : PhoneApplicationPage
    {
        ...
        void OnSliderDebugValueChanged(object sender, System.Windows.RoutedPropertyChangedEventArgs<double> e)
        {
            _sliderValue = (int)Math.Round(e.NewValue);
        }
        ...
        private void PixelateWriteableBitmap()
        {
            ...
            var pixelated = _pixelator.Pixelate(_originalPixels, _writableBitmap.PixelWidth, _writableBitmap.PixelHeight, _sliderValue);
