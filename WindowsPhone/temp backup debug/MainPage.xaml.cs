...
namespace EightBitCamera
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        public MainPage()
        {
            ...
            textBoxDebug.TextChanged += OnTextBoxDebugTextChanged;
        }

        private void OnTextBoxDebugTextChanged(object sender, TextChangedEventArgs e)
        {
            try
            {
                _sliderValue = int.Parse(textBoxDebug.Text);
            }
            catch (Exception)
            {
            }
        ...
        private void UpdateViewFinder(object state)
        {
            ...
            try
            {
                ...
                buffer = _pixelator.Pixelate(buffer, width, height, _sliderValue);
